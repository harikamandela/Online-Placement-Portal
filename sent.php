...
<div id="page">
	...
	<div id="sidebar">
		...
		<a class="active" href="sent.php">Sent</a>
	...
	<div id="contentarea">
		...
		<?php
				...
				$query="select * from inbox where too='".$var."' and flag='".$sflag."'";
				...
				if(mysqli_num_rows($sql)>0)
				{
					...
					{
						echo "<tr class='rowB'>";
						echo "<a href='readsent.php?id=".$row[0]."'>";
						echo "<td>".$row[5]."</td>";
						echo "<td>".$row[2]."</td>";
						echo "<td>".$row[3]."</td>";
						echo "<td>";
						...
						echo "<a href='readsent.php?id=".$row[0]."'>"; ?><img src="images/read.ico" alt="read" height="15" width="15">
						<?php
						echo "</td>";
						?>
						</a>
						<?php
						echo "<td>";
						echo "<a href='deletesent.php?id=".$row[0]."'>";
						?>
